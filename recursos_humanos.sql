...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-02-2020 a las 18:55:23
...
ALTER TABLE `candidato_has_habilidad`
  ADD KEY `fk_Candidato_has_Habilidad_Candidato1` (`Curp`),
...
ALTER TABLE `nivel_academico_has_candidato`
  ADD KEY `fk_Nivel_Academico_has_Candidato_Candidato1` (`Curp`),
  ADD KEY `fk_Nivel_Academico_has_Candidato_Nivel_Academico1` (`idNivel_Academico`),
  ADD KEY `fk_Nivel_Academico_has_Candidato_Carrera1` (`idCarrera`);
...
--
ALTER TABLE `nivel_academico_has_candidato`
  ADD CONSTRAINT `fk_Nivel_Academico_has_Candidato_Candidato1` FOREIGN KEY (`Curp`) REFERENCES `candidato` (`Curp`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Nivel_Academico_has_Candidato_Carrera1` FOREIGN KEY (`idCarrera`) REFERENCES `carrera` (`idCarrera`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Nivel_Academico_has_Candidato_Nivel_Academico1` FOREIGN KEY (`idNivel_Academico`) REFERENCES `nivel_academico` (`idNivel_Academico`) ON DELETE NO ACTION ON UPDATE NO ACTION;
